...
// Importamos fireEvent novamente
import { fireEvent, render, screen } from '@testing-library/react'
import { Slider, type SliderProps } from './index'

// A importação do userEvent não é mais necessária para estes testes
...
describe('<Slider />', () => {
  ...
  it('should update value and call onChange when user interacts', () => {
    ...
    // act
    // Usamos fireEvent.change para simular diretamente a mudança de valor
